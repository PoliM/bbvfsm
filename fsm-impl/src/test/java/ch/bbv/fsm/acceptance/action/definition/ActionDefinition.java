...
public class ActionDefinition implements Action<SimpleStateMachine, State, Event> {
   ...
   * CLASS
   */
  public static class ActionDefinitionInner implements Action<SimpleStateMachine, State, Event> {
  ...
  public static final class ActionDefinitionInnerWithoutDefaultConstructor implements
      Action<SimpleStateMachine, State, Event> {
  ...
  public static class ActionDefinitionEntryWithParameter implements
    ...
    public void execute(final SimpleStateMachine stateMachine, final Object... arguments) {
      ...
      stateMachine.log("execute: ActionDefinition$ActionDefinitionEntryWithParameter.execute("
          + arguments[0] + ")");
    }
  }
