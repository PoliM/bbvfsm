...
public class StateBuilder<TStateMachine extends StateMachine<TState, TEvent>, TState extends Enum<?>, TEvent extends Enum<?>>
    ...
    EventActionSyntax<TStateMachine, TState, TEvent>, ExecuteSyntax<TStateMachine, TState, TEvent>,
  ...
  public ExecuteSyntax<TStateMachine, TState, TEvent> execute(
      final Action<TStateMachine, TState, TEvent> embeddedAction) {
  ...
  public ExitActionSyntax<TStateMachine, TState, TEvent> executeOnEntry(
    ...
    this.internalState.setEntryAction(new ActionHolderNoParameter<>(action));
  ...
  public <T> ExitActionSyntax<TStateMachine, TState, TEvent> executeOnEntry(
      final Action<TStateMachine, TState, TEvent> actionClass, final T parameter) {

    this.internalState.setEntryAction(new ActionHolderParameter<>(actionClass, parameter));
    return this;
  }

  @Override
  public ExitActionSyntax<TStateMachine, TState, TEvent> executeOnExit(
      final Action<TStateMachine, TState, TEvent> actionClass) {

    this.internalState.setExitAction(new ActionHolderNoParameter<>(actionClass));
  ...
  public <T> EventSyntax<TStateMachine, TState, TEvent> executeOnExit(
    ...
    this.internalState.setExitAction(new ActionHolderParameter<>(
